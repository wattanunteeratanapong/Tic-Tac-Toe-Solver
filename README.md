...
In this solver i implement by using data structure that behave like a "Linked List" but having 9 branch to store the generate event. <br>
Implementing like this will make it fast to search, because it didn't have to iterate through the tree like preorder/inorder/postorder. <br>
but it might take a bit of time to generate all sample space by recursive. <br>
<br><br>
